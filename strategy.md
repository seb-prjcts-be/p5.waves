...
### Internal normalization (2026-03-30)

All 34 wave formulas normalized to [-1, 1] before amplitude scaling.
Amplitude now guarantees consistent output range regardless of formula.
Shift transitions smooth, wild mode predictable. Version bumped to 2.2.0.
Example amplitude values reduced (~50%) to compensate for full-range output.
